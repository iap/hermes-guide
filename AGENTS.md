...
| `__init__.py` | Plugin entrypoint — registers `/hermes-doctor` and `hermes guide` (the twelve skills ship separately via the skills tap) |
...
| `skills/*/SKILL.md` | The twelve skills (one map + eleven diagnostics) |
